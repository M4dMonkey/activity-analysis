...
(function(){
    ...
    d3.json("data2.json", function(err, data){
        ...
        surveyData = [
            ...
            [
                {"area": "Sleeping", "value": 5},
                {"area": "Leisure and sports", "value": 0.5},
                {"area": "Educational activities", "value": 8},
        ...
        RadarChart.draw("#radar-chart-container", surveyData, config, ["Avg", "SWY", "SYL"]);
